...
# Simon van Eeden
#
# Running this code will excecute gaussian fit and exponential fits automaticly
...
print("NOTE: This process may take a while...")
...
for l in read_file:
    ...
    if not l[0] == '#':
        ...
        # Save new source name
        if read_source:  
            # Read and save source name
            plotted_telescopes = []
            lc_name = row[0]  
            print(f'### {lc_name} ###')
